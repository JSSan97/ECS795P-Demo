...
def main():
    ...
    parser.add_argument('--model_name', type=str, default='VGG13', choices=['VGG16', 'ResNet101', 'ResNet101SE', 'ResidualAttention', 'ResidualAttentionSE'], help='Name of architecture')
